...
def switches_sizing(
    ...
    devices.__data_frame__(dev_type="switch").to_json(
        os.path.join(output_dir, "switches.json")
    )
    devices.__data_frame__(dev_type="switch").to_json(
        os.path.join(output_dir, "switches.csv")
    )
    devices.__data_frame__(dev_type="switch").to_markdown(
        os.path.join(output_dir, "switches.md")
    )
    devices.__data_frame__(dev_type="switch").to_latex(
        os.path.join(output_dir, "switches.tex")
    )
